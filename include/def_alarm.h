...
#define CONFIG_ALARM_MQTT_RXIR_UNKNOWN_TOPIC "rxIRnew"
#define CONFIG_ALARM_MQTT_RXIR_UNKNOWN_LOCAL 0
#define CONFIG_ALARM_MQTT_RXIR_UNKNOWN_QOS 0
#define CONFIG_ALARM_MQTT_RXIR_UNKNOWN_RETAINED 1
...
#define CONFIG_ALARM_PARAMS_FIX_RXIR_CODES_KEY "fix_ir_codes"
#define CONFIG_ALARM_PARAMS_FIX_RXIR_CODES_FRIENDLY "Фиксировать новые RXIR коды"
